...
class MinhaApp(App):
    def build (self):
        ...
        btn_enviar = Button(text='Enviar', on_press=self.exibir_mensagem)
        layout_principal.add_widget(btn_enviar)
    ...
    def exibir_mensagem(self, instance):
        mensagem = (f'Olá {self.input_nome.text}, você está avançando no kivy, pabens SESIANO!!!!!')
